    ...
    render() {
        ...
        return (
            <div className='detail-container'>
                <div dangerouslySetInnerHTML={rawHTML} onClick={this.changeInfo} style={{ cursor: 'pointer', textAlign: 'center' }}></div>
                <div style={{ fontSize: '20px', color: 'red', textAlign: 'center' }}>{this.state.text}</div>
